...
# ============================================================
doc.add_heading('山崎慎慈氏によるRaspberry Pi 5 DVB-S2受信システムの再捕捉安定化に関する技術報告', level=0)
...
h1('エグゼクティブサマリー')
p('Raspberry Pi 5 + PlutoSDR による DVB-S2 受信ソフトウェアのビルド環境整備から始まり、'
...
p('生IQサンプルを`iio_readdev`で直接キャプチャして実測した結果、Raspberry Pi 5とPlutoSDR間の'
...
h1('8. 結論')
p('本調査を通じて、Raspberry Pi 5 + PlutoSDR構成でのDVB-S2受信は、SD・HD双方で'
