...
# ============================================================
doc.add_heading('Technical Report on Reacquisition Stabilization of a Raspberry Pi 5 '
...
p('Starting from setting up the build environment for a DVB-S2 receiver application '
  '(Raspberry Pi 5 + PlutoSDR), this report covers a series of technical '
...
p('By capturing raw IQ samples directly with `iio_readdev` and measuring the '
  ...
  'in the effective USB throughput between the Raspberry Pi 5 and the PlutoSDR.')
table(
...
h1('8. Conclusion')
p('Through this investigation, DVB-S2 reception on a Raspberry Pi 5 + PlutoSDR '
