...
MANUAL_SECTIONS_WIN_EN = [
    ...
    ("3. Settings Screen", [
        ...
        ("Video overlay (callsign)", "Enter the callsign and an optional note to be burned into the camera video. They apply only to camera video, not to the test pattern or an image file."),
