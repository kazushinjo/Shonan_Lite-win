...
MANUAL_SECTIONS_WIN_EN = [
    ...
    ("3. Settings Screen", [
        ...
        ("Video overlay (callsign)", "Enter the callsign and an optional note to be burned into the video. They apply to camera video and to an image file (the test pattern already has a callsign drawn into it, so it is not overlaid)."),
