...
MANUAL_SECTIONS_WIN_EN = [
    ...
    ("3. Settings Screen", [
        ...
        ("Video overlay (callsign)", "Enter the callsign and an optional note to be burned into the camera video. They apply only to camera video, not to the test pattern or a video file."),
    ...
    ("4. Settings Before Transmitting", [
        ...
        ("Video Source", "The Video Source screen lets you choose a Windows USB camera or capture device detected by ffmpeg, a video file (ts/mp4/mkv/mov/avi), or a test pattern (color bars). You can also choose the resolution (1920x1080/1280x720/640x480) and frame rate (30/25/15 fps). If no device name is shown, check that ffmpeg is bundled (installed automatically by the installer) and check the camera driver and connection."),
