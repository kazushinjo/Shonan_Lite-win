...
class TxPowerScreen(SettingsSubScreen):
    def __init__(self, main_window):
        ...
        self.power_label.setStyleSheet("font-size: 29px; color: white;")
        ...
        note = QtWidgets.QLabel(tr(
            "0 dB = 最大出力、値が小さいほど減衰します。",
            "0 dB = maximum output; lower values attenuate more."))
        note.setStyleSheet("color: #9aa0a6; font-size: 28px;")
