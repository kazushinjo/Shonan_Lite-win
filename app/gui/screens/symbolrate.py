...
class SymbolRateScreen(SettingsSubScreen):
    def __init__(self, main_window):
        ...
        preset_title.setStyleSheet("font-size: 29px; font-weight: bold; color: #cccccc;")
        ...
        for msps in _PRESETS_MSPS:
            ...
            button.setStyleSheet(
                ...
                " border-radius: 6px; padding: 3px 8px; text-align: left; font-size: 29px;"
        ...
        custom_title.setStyleSheet("font-size: 29px; font-weight: bold; color: #cccccc;")
        ...
        rate_label.setStyleSheet("font-size: 29px; font-weight: bold; color: white;")
        ...
        unit.setStyleSheet("font-size: 28px; color: #9aa0a6;")
        ...
        for text, row, column in [("7", 0, 0), ("8", 0, 1), ("9", 0, 2), ("DEL", 0, 3),
            ...
            button.setFixedSize(78, 46)
            button.setStyleSheet("QPushButton { background: #252a2d; color: white; border: 1px solid #69747a; border-radius: 6px; font-size: 29px; font-weight: bold; min-width: 78px; max-width: 78px; min-height: 46px; max-height: 46px; padding: 0px; } QPushButton:pressed { background: #0c9bc0; }")
            if text == "−":
        ...
        current.setStyleSheet("font-size: 29px; color: #0c9bc0; font-weight: bold;")
        self.current_label = current
        custom_layout.addWidget(current)
        recommended = QtWidgets.QLabel(tr("帯域幅の目安: 5.0 MHz", "Approx. bandwidth: 5.0 MHz"))
        recommended.setStyleSheet("font-size: 28px; color: #9aa0a6;")
