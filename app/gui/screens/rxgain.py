...
class RxGainScreen(SettingsSubScreen):
    def __init__(self, main_window):
        ...
        auto_label.setStyleSheet("font-size: 28px; color: #cccccc;")
        ...
        for text in ("0", "20", "40", "60", "80", "100"):
            ...
            label.setStyleSheet("font-size: 28px; color: #9aa0a6;")
        ...
        self.gain_label.setStyleSheet("font-size: 29px; color: white;")
        ...
        level_title.setStyleSheet("font-size: 29px; font-weight: bold; color: #cccccc;")
        level_layout.addWidget(level_title)
        self.level_value = QtWidgets.QLabel("72 %")
        self.level_value.setStyleSheet("font-size: 29px; font-weight: bold; color: white;")
